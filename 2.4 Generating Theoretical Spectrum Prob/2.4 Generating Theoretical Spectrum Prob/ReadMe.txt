========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта 2.4 Generating Theoretical Spectrum Prob
========================================================================

Это приложение 2.4 Generating Theoretical Spectrum Prob создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения 2.4 Generating Theoretical Spectrum Prob.


2.4 Generating Theoretical Spectrum Prob.vcxproj
...
2.4 Generating Theoretical Spectrum Prob.vcxproj.filters
...
2.4 Generating Theoretical Spectrum Prob.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем 2.4 Generating Theoretical Spectrum Prob.pch и файла предкомпилированных типов с именем StdAfx.obj.
